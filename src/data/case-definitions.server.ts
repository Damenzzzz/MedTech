import { CaseDefinition } from '@/domain/schemas';
...
export const caseDefinitions: Record<string, CaseDefinition> = {
  ...
  'migraine-aura': {
    ...
    differentials: [
      ...
      { code: 'G44.0', name: t('Кластерная (пучковая) головная боль', 'Кластерлі (шоғырлы) бас ауруы', 'Cluster headache') },
    ],
    examinations: [
  ...
  'viral-uri': {
    ...
    differentials: [
      ...
      { code: 'J30.1', name: t('Аллергический ринит', 'Аллергиялық ринит', 'Allergic rhinitis') },
    ],
    examinations: [
  ...
  'influenza': {
    ...
    differentials: [
      ...
      { code: 'J02.0', name: t('Острый стрептококковый фарингит', 'Жедел стрептококкты фарингит', 'Acute streptococcal pharyngitis') },
    ],
    examinations: [
  ...
  'sepsis': {
    ...
    differentials: [
      ...
      { code: 'N10', name: t('Острый пиелонефрит (уросепсис)', 'Жедел пиелонефрит (уросепсис)', 'Acute pyelonephritis (urosepsis)') },
    ],
    examinations: [
  ...
  'covid-like': {
    ...
    differentials: [
      ...
      { code: 'J11.1', name: t('Грипп', 'Тұмау', 'Influenza') },
      { code: 'J18.9', name: t('Внебольничная пневмония', 'Қауымдастықтан тыс пневмония', 'Community-acquired pneumonia') },
      { code: 'B34.2', name: t('Аденовирусный фарингоконъюнктивит', 'Аденовирустық фарингоконъюнктивит', 'Adenoviral pharyngoconjunctivitis') },
    ],
    examinations: [
