  ...
  return <div className="grid gap-5 py-6 lg:grid-cols-[430px_minmax(0,1fr)]">
    ...
    <section className="space-y-5">
      ...
      <div className="rounded-2xl border border-white/10 bg-[#162320] p-5">
        ...
        <p className="mt-4 rounded-xl border border-amber-400/20 bg-amber-400/8 p-3 text-xs leading-5 text-amber-100">Если нужна конкретная тактика, нажмите “Дать действия”: LLM сам решит, достаточно ли быстрого ответа или нужен медленный RAG по протоколам.</p>
      </div>
